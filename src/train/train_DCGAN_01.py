                ...
                for i, images in enumerate(meta_train_loader):
                    ...
                    for j, image in enumerate(train_loader):
                        ...
                        if j == 0:
                            ...
                            os.makedirs(f"{self.params['checkpoint_path']}/{self.model_path}/spectra", exist_ok=True)
                            try:
                                plt.savefig(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--bin", type=str, default='01')
    ...
    if 'dcgan' in args.model:
        ...
        from src.models.pytorch.unsupervised.GANs.PacGAN_1D01 import Generator as gen
        from src.models.pytorch.unsupervised.GANs.PacGAN_1D01 import Discriminator as dis
